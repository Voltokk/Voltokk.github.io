...
window.taAddValidator (injectcdsratingsonlywide814)

                  if(document.createStyleSheet) {
        document.createStyleSheet("https://static.tacdn.com/css2/t4b_widget_ratingsonly-v21810207393a.css");
      } else {
        var stylesImport = "@import url(' https://static.tacdn.com/css2/t4b_widget_ratingsonly-v21810207393a.css ');";
    ...
    newJs.setAttribute('src', 'https://static.tacdn.com/js3/widget/cdswidgets_m-c-v2926871653a.js');
...
function injectcdsratingsonlywide814() {
    var container = document.getElementById('TA_cdsratingsonlywide637');
  if (container == null) {
        var scriptTags = document.getElementsByTagName("script");
    for (var i=0; i<scriptTags.length; i++)
    {
      if (scriptTags[i] != null && scriptTags[i].src != null &&
          scriptTags[i].src.indexOf("cdsratingsonlywide?uniq=637") >= 0)
      {
  ...
  holderElement.innerHTML = '<img src="https://p.travelsmarter.net/api/usersync/seed.gif?api_key=gqLWKHSnTxes4YmmtgWkqA&loc_id=1160010&publisher_browser_id=360aa2121a3d1a4d8ed62181481d0a163954cb09&cb=1509279571788" alt="" width="0" height="0"> '+
'<div id="CDSRATINGWIDGET637" class="cdsROW white    wide "> '+
'<div id="CDSROWCONTAINER637" class="cdsROWContainer"> '+
'<!--[if lte IE 7]> '+
'      <table border="0" cellspacing="0"> '+
'        <tr> '+
'          <td>    <div id="CDSROWLOGO637" class="cdsComponent logo"> '+
'                                       '+
'    <a target="_blank" href="https://www.tripadvisor.co.uk/"><img  src="https://www.tripadvisor.co.uk/img/cdsi/img2/branding/tripadvisor_logo_transp_340x80-18034-2.png" alt="TripAdvisor"/></a> '+
'  </div> '+
'</td> '+
'          <td>  <div id="CDSROWLOC637" class="cdsComponent cdsLocName"> '+
'    <a id="CDSLOCINNER" target="_blank" href="https://www.tripadvisor.co.uk/Restaurant_Review-g187803-d1160010-Reviews-Osteria_Francescana-Modena_Province_of_Modena_Emilia_Romagna.html" onclick="ta.cds.handleTALink($cdsConfig.getMcid()); return true;">Osteria Francescana</a> '+
'  </div> '+
'</td> '+
'          <td>  <div id="CDSROWRATING637" class="cdsComponent cdsRating"> '+
...
'      <![endif]--> '+
'<!--[if gte IE 8]><!--> '+
'<div id="CDSROWLOGO637" class="cdsComponent logo"> '+
'<a target="_blank" href="https://www.tripadvisor.co.uk/"><img src="https://www.tripadvisor.co.uk/img/cdsi/img2/branding/tripadvisor_logo_transp_340x80-18034-2.png" alt="TripAdvisor"/></a> '+
'</div> '+
'<div id="CDSROWLOC637" class="cdsComponent cdsLocName"> '+
'<a id="CDSLOCINNER" target="_blank" href="https://www.tripadvisor.co.uk/Restaurant_Review-g187803-d1160010-Reviews-Osteria_Francescana-Modena_Province_of_Modena_Emilia_Romagna.html" onclick="ta.cds.handleTALink($cdsConfig.getMcid()); return true;">Osteria Francescana</a> '+
'</div> '+
'<div id="CDSROWRATING637" class="cdsComponent cdsRating"> '+
'<span class="ui_bubble_rating bubble_45"></span> '+
'<span> '+
'1,887 Reviews </span> '+
'</div> '+
...
'</div> '+
'</div> '+
'<img style="display:none;" src="https://www.tripadvisor.co.uk/img/cdsi/img2/branding/tripadvisor_logo_transp_340x80-18034-2.png" onload="resizeRatingsOnlyWidget({  '+
'    wide: true, '+
'    widgetDivId: \'CDSRATINGWIDGET637\', '+
'    locDivId: \'CDSROWLOC637\', '+
'    maxLocFontSize: 14, '+
'    maxHeight: 47 '+
...
'';
  ...
  if (links) {
    ...
    var widgetHtml = '<img src="https://p.travelsmarter.net/api/usersync/seed.gif?api_key=gqLWKHSnTxes4YmmtgWkqA&loc_id=1160010&publisher_browser_id=360aa2121a3d1a4d8ed62181481d0a163954cb09&cb=1509279571788" alt="" width="0" height="0"> '+
'<div id="CDSRATINGWIDGET637" class="cdsROW white    wide "> '+
'<div id="CDSROWCONTAINER637" class="cdsROWContainer"> '+
'<!--[if lte IE 7]> '+
'      <table border="0" cellspacing="0"> '+
    ...
    if (links) {
      for (var i=0; i<links.length; ++i) {
          ...
          linksDiv.appendChild(linkDiv);
            ...
            var cdsWidgetKey = 'cdsratingsonlywide';
